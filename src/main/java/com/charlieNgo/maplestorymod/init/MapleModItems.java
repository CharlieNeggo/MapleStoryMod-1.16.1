...
//import com.charlieNgo.maplestorymod.items.Comsumables.Elixir;
import com.charlieNgo.maplestorymod.items.Comsumables.*;
...
public class MapleModItems {
    ...
    public static final RegistryObject<MapleModSpawnEggItem> GREEN_SLIME_SPAWN_EGG = ITEMS.register("green_slime_spawn_egg", () -> new MapleModSpawnEggItem
            (MapleModEntityTypes.GREENSLIME, 0xF1BF7B, 0x4AED3C, new Item.Properties().group(MapleStoryMod.TAB)));
